...
result = checkSimulation(CauerLowPassOPV, 60, "C9.v", -0.5003139583081188)
...
result = checkSimulation(CauerLowPassOPVWithoutNodes, 60, "C9.v", -0.5003139583081188, tearing=false)
