...
firstOrder = @instantiateModel(FirstOrder, log=true)
simulate!(firstOrder, stopTime=3.0)

@usingModiaPlot
plot(firstOrder, ("u", "x", "der(x)"), figure=1)
...
circuit = @instantiateModel(Circuit, unitless=true)
simulate!(circuit, stopTime=4.0)
@usingModiaPlot
plot(circuit, [("R.v", "C.v"); ("R.i", "C.i")], figure=2)
